...
import { Mail, Lock, Eye, EyeOff, Phone, Stethoscope, Shield, ArrowLeft, Building2 } from "lucide-react"
...
const signupSchema = z
  .object({
    ...
    bmdcNumber: z.string().min(5, "Please enter a valid BMDC license number"),
...
export default function DoctorAuthPage() {
  ...
  const onSigninSubmit: SubmitHandler<SigninFormValues> = (data) => {
    console.log("Doctor signin:", data)
      ...
      <div className="relative z-10 w-full max-w-md">
        <Card className="shadow-xl border-0 bg-white">
          <CardHeader className="text-center space-y-4 relative">
            ...
            <div>
              <CardTitle className="text-2xl font-bold text-slate-800">Healthcare Provider</CardTitle>
              <CardDescription className="text-slate-500 mt-2">Access your professional dashboard</CardDescription>
            </div>
          </CardHeader>
                ...
                <Form {...signupForm}>
                  <form onSubmit={signupForm.handleSubmit(onSignupSubmit)} className="space-y-4">
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel className="text-slate-700 font-medium">BMDC License Number</FormLabel>
                          <FormControl>
                            <div className="relative">
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel className="text-slate-700 font-medium">Hospital/Clinic</FormLabel>
                          <FormControl>
                            <div className="relative">
