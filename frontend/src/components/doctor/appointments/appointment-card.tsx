...
import { Calendar, Clock, User, AlertCircle, Stethoscope, CheckCircle, Edit, Trash2 } from 'lucide-react'
import { format } from 'date-fns'
import { getStatusIcon } from '@/components/ui-lib'
import { useUpdateAppointment } from '@/lib/api/appointment.service'
