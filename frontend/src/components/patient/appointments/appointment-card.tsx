...
import { Calendar, Clock, MapPin, User, Video, AlertCircle, Trash2 } from 'lucide-react'
import { format } from 'date-fns'
import { getStatusIcon } from '@/components/ui-lib'
import { useDeleteAppointment } from '@/lib/api/appointment.service'
    ...
    return (
        <>
            ...
            <CancelConfirmationDialog
                ...
                description={`Are you sure you want to cancel your appointment with Dr. ${appointment.doctor_name}? This action cannot be undone.`}
